...
class LangGraphFactory:
    ...
    """
    def __init__(self, state_schema: Any, checkpointer: Any = None,store: Any = None) -> None:
        """
    ...
    async def create_graph(self, build_fn: Callable[[StateGraph], Any]) -> CompiledStateGraph:
        ...
        return graph_builder.compile(checkpointer=self.checkpointer,store = self.store)
